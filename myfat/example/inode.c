			     ...
			     loff_t offset, unsigned long nr_segs)
{
	...
	printk (KERN_INFO "myfat: fat_direct_IO, offset is %lld\n", offset);
	printk (KERN_INFO "myfat: fat_direct_IO, len is %d\n", len);
	if (rw == WRITE) {
		/*
		...
		printk (KERN_INFO "myfat: fat_direct_IO, size is %lld\n", size);
		   ...
		   const struct inode_operations *fs_dir_inode_ops, int isvfat)
{
	...
	printk(KERN_ERR "FAT: fat_fill_super\n");
	/*
	...
	printk(KERN_INFO "fat_fill_super sbi->cluster_size = %u", sbi->cluster_size);
